    ...
    <main>
        <section>
            ...
            <div class="pricetable">
                <%-- PersonPrice --%>
                <asp:DataList ID="DataList1" runat="server" CellPadding="4" DataSourceID="PersonPrice" ForeColor="#333333">
...
<br />
                ...
                <%-- OrderingCost --%>
                <asp:DataList ID="DataList2" runat="server" CellPadding="4" DataKeyField="Item" DataSourceID="OrderingCost" ForeColor="#333333">
                    <AlternatingItemStyle BackColor="White" />
                    <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                    <HeaderStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                    <HeaderTemplate>
