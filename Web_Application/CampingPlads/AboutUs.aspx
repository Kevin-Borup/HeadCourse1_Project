...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/AboutUsSS.css" rel="stylesheet" />
</asp:Content>
        ...
        <article>
            ...
            <div class="abusFig">
                <figure class="bgBox">
                    ...
                    <figcaption>Jørgen & Birthe Carlsen</figcaption>
                </figure>
                <p class="leftOfImg">
                    ...
                    <br />
                    Selve pladsen har plads til, og er godkendt til, 217 pladser på deres i alt ca. 4 hektar. 
                    Derudover er der 7 hytter på 16 m<sup>2</sup> hver og 6 luksus hytter på 20 m<sup>2</sup>.
                </p>
            </div>
        </article>
    </main>
