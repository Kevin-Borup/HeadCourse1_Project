...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
        ...
        <section class="Cal">
            <h6>Start Dato</h6>
            <hr />
            <asp:Calendar ID="ReservationCal" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="350px" NextPrevFormat="FullMonth" OnSelectionChanged="ReservationCal_SelectionChanged">
